...
const registerSchema = z.object({
  UserName: z.string().min(3, { message: 'User Name must be at least 3 characters' }).max(50, { message: 'Name must be at most 50 characters' }),
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="mb-4">
        ...
        {errors.Name && (
          <p className="text-rose-500 text-sm mt-1">{errors.Name.message as ReactNode}</p>
        )}
      </div>
      <div className="mb-4">
        ...
        {errors.Email && (
          <p className="text-rose-500 text-sm mt-1">{errors.Email.message as ReactNode}</p>
        )}
      </div>
      <div className="mb-4 relative">
        ...
        {errors.Password && (
          <p className="text-rose-500 text-sm mt-1">{errors.Password.message as ReactNode}</p>
        )}
      </div>
